package com.hollysmart.loginmodule.view.statusbar;
...
public class StatusBarHeightView extends LinearLayout {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.LoginModuleStatusBarHeightView);
            type = typedArray.getInt(R.styleable.LoginModuleStatusBarHeightView_loginmodule_use_type, 0);
            typedArray.recycle();
        }
        if (type == 1) {
