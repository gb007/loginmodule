package com.hollysmart.loginmodule.view;
...
public class EasyGestureLockLayout extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        paint_error.setColor(getResources().getColor(R.color.login_module_colorCheckedErr));
    ...
    private GestureLockCircleView getCircleView(int wh) {
        ...
        gestureCircleView.setInnerCircle(getResources().getColor(R.color.login_module_colorChecked), (float) (wh / s));
        ...
        gestureCircleView.setBorderRound(hasRoundBorder, getResources().getColor(R.color.login_module_colorChecked), (float) (wh / s));//是否有边框，外圆颜色，外圆半径
